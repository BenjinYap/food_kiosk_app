...
function Home() {
  return (
    <Container maxWidth={false}>
      ...
      <Typography>I find self-checkout and fast food kiosks very interesting because I always notice when the UI for a
        restaurant or grocery store is particularly good or bad.</Typography>
      <Typography>This is my attempt at creating a UI that combines all the best examples I've encountered.</Typography><Typography>I
      find self-checkout and fast food kiosks very interesting because I always notice when the UI for a
      restaurant or grocery store is particularly good or bad.</Typography>
      <Typography>This is my attempt at creating a UI that combines all the best examples I've encountered.</Typography><Typography>I
      find self-checkout and fast food kiosks very interesting because I always notice when the UI for a
      restaurant or grocery store is particularly good or bad.</Typography>
